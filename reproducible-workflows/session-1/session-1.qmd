...
<div class="paper-adv-backdrop" hidden></div>
<div class="paper-adv-modal" hidden>
<div class="paper-adv-head"><strong>Rendered figure</strong><button type="button" class="paper-adv-close" aria-label="Close">&times;</button></div>
<div class="adv-body">
```{r}
#| label: fig-penguins
#| fig-cap: "Bill length across penguin species."
...
<div class="paper-adv-backdrop" hidden></div>
<div class="paper-adv-modal" hidden>
<div class="paper-adv-head"><strong>Rendered `{gt}` table</strong><button type="button" class="paper-adv-close" aria-label="Close">&times;</button></div>
<div class="adv-body">
```{r}
#| label: tbl-penguins-summary
#| tbl-cap: "Mean bill length (mm) by penguin species."
